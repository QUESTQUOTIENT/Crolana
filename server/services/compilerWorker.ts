/**
 * server/services/compilerWorker.ts
 *
 * Worker thread entry point for solc compilation.
 * Runs in a separate thread so the main Express event loop is never blocked.
 * Called by compiler.ts via worker_threads.
 */
