/**
 * services/analytics-indexer/index.ts
 * Background analytics indexer — reads blockchain events and writes DB snapshots.
 * Upgraded: Prisma DB integration (with in-memory fallback when DB unavailable).
 */
...
// ─────────────────────────────────────────────────────────────
// DB (Prisma with in-memory fallback)
// ─────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────
// API Server (exposes snapshot data on port 3001)
// ─────────────────────────────────────────────────────────────
...
async function startApiServer(contracts: IndexerConfig[]) {
  ...
  // Register a new contract to watch
