/**
 * src/pages/SolanaTokenBuilder.tsx
 *
 * SPL Token creation for Solana. Mirrors TokenBuilderPage.tsx (ERC-20)
 * but creates Solana SPL tokens using @solana/spl-token.
 *
 * Comparable features to ERC-20 builder:
 *  - Name, symbol, decimals, initial supply
 *  - Revoke mint authority (fixed supply — like ERC-20 without minting)
...
export function SolanaTokenBuilder() {
  ...
  // Keep config.cluster in sync when user switches network
