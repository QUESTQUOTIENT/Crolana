...
import {
  ...
  Coins, Shield, Cpu, Globe, ChevronDown, ChevronUp, ExternalLink,
  ...
  return (
    <div className="space-y-12 max-w-4xl">
      ...
      <div>
        ...
        <p className="text-slate-500 text-sm mb-6">Twelve integrated systems covering the full lifecycle of NFT creation, DeFi operations, and tooling on Cronos.</p>
