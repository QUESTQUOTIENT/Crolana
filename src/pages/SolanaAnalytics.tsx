/**
 * src/pages/SolanaAnalytics.tsx
 *
 * On-chain analytics for Solana NFT collections / SPL tokens.
 * Uses Solana JSON-RPC directly — no external API key needed.
 * Mirrors Analytics.tsx for EVM.
 */
...
// RPC calls go through the server proxy to avoid CORS + rate limiting
