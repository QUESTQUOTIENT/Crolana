...
// ALL pages lazy-loaded — Solana/Metaplex chunks are never downloaded at startup.
// This prevents the SES lockdown BN crash from blanking the screen on mobile.
...
// These pull in the solana-bundle chunk only when navigated to.
...
export default function App() {
  return (
    <ErrorBoundary>
      <BrowserRouter>
        <Routes>
          {/* Public mint page — standalone, no sidebar or header */}
