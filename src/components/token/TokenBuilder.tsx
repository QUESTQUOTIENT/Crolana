...
export function TokenBuilder() {
  ...
  // ── Compile ───────────────────────────────────────────────────────────────
  // Extract contract name from Solidity source as fallback when state is null
  ...
  const handleCompile = async () => {
    ...
    // Resolve contractName: use state value if present, else extract from source
    ...
    try {
      ...
      // Update contractName state in case it was extracted from source
