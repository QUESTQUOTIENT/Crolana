  ...
  const handleAirdrop = async () => {
    ...
    try {
      ...
      for (let i = 0; i < recipients.length; i += BATCH_SIZE) {
        ...
        // In a real scenario, you'd want a batchMint function on the contract
        // e.g., function airdrop(address[] calldata to, uint256[] calldata amounts)
        // Since our current generator only has ownerMint(to, amount), we have to loop
        // This is inefficient and might fail if there are too many, but works for demo
        
        // For demonstration, we'll just execute them sequentially
